...
def get_args():    
    ...
    parser.add_argument('--model_type', type=str, 
                        ...
                        choices=['mlp', 'resnet', 'ftt', 'node', 'autoint',
                                 ...
                                 'contra-knn','contra-ncm','contra-lr','contra-nca',
                                 'contra-wknn']) # 
...
def objective(trial):
    ...
    if args.model_type in ['modernNCA','contra-knn','contra-ncm','contra-lr','contra-nca','contra-wknn']:
        config['model']["num_embeddings"].setdefault('type', 'PLREmbeddings')
        config['model']["num_embeddings"].setdefault('lite', True)
    if args.model_type in ['contra-wknn']:
        config['model']["pred_mode"]="knn"    
